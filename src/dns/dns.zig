...
pub const GetAddrInfo = struct {
    ...
    pub const Result = struct {
        ...
        pub fn fromAddrInfo(addrinfo: *std.c.addrinfo) ?Result {
            return Result{
                .address = bun.compat.NetAddress.initPosix(@alignCast(addrinfo.addr orelse return null)),
...
pub fn addressToString(address: *const bun.compat.NetAddress) bun.OOM!bun.String {
