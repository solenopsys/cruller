...
pub const Deadline = struct {
    ...
    pub fn init(expires_in_ns: ?u64) Deadline {
        ...
        // bun.compat.Timer is required to be supported for somewhat accurate reportings of error.Timeout.
        if (deadline.timeout != null) {
            deadline.started = bun.compat.Timer.start() catch unreachable;
        }
