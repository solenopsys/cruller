...
const MacroRefs = bun.compat.AutoArrayHashMapManaged(Ref, MacroRefData);
...
pub const MacroState = struct {
    ...
    imports: bun.compat.AutoArrayHashMapManaged(i32, Ref),

    pub fn init(allocator: Allocator) MacroState {
        return MacroState{
            .refs = MacroRefs.init(allocator),
            .prepend_stmts = undefined,
            .imports = bun.compat.AutoArrayHashMapManaged(i32, Ref).init(allocator),
        };
    }
};
