...
pub const Writer = bun.compat.GenericWriter(*@This(), Allocator.Error, MutableString.writeAll);
...
pub const BufferedWriter = struct {
    ...
    pub const Writer = bun.compat.GenericWriter(*BufferedWriter, Allocator.Error, BufferedWriter.writeAll);
