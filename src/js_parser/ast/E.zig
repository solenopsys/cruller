...
// bzrt-cut:     pub const toJS = @import("../../js_parser_jsc/expr_jsc.zig").arrayToJS;
...
pub const Boolean = struct {
    value: bool,
// bzrt-cut:     pub const toJS = @import("../../js_parser_jsc/expr_jsc.zig").boolToJS;
};
...
// bzrt-cut:     pub const toJS = @import("../../js_parser_jsc/expr_jsc.zig").numberToJS;
};
...
// bzrt-cut:     pub const toJS = @import("../../js_parser_jsc/expr_jsc.zig").bigIntToJS;
};
...
// bzrt-cut:     pub const toJS = @import("../../js_parser_jsc/expr_jsc.zig").objectToJS;
...
// bzrt-cut:     pub const toJS = @import("../../js_parser_jsc/expr_jsc.zig").stringToJS;
