...
// bzrt-cut: pub const fromJS = @import("../bundler_jsc/options_jsc.zig").compileTargetFromJS;
// bzrt-cut: pub const fromSlice = @import("../bundler_jsc/options_jsc.zig").compileTargetFromSlice;
