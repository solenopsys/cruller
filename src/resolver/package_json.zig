...
pub const ESModule = struct {
    ...
    pub fn finalize(result_: Resolution) Resolution {
        ...
        var fbs = bun.compat.fixedBufferStream(resolved_path_buf_percent);
...
// bzrt-cut: const Install = @import("../install/install.zig");
// bzrt-cut: const cache = @import("../bundler/cache.zig");
...
// bzrt-cut: const OperatingSystem = @import("../install/npm.zig").OperatingSystem;
