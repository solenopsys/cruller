        ...
        const MappingProps = struct {
            ...
            pub fn appendMaybeMerge(self: *MappingProps, key: Expr, value: Expr) OOM!void {
                if (switch (key.data) {
                    ...
                    return self.priv_list.append(.{ .key = key, .value = value });
                }
                ...
                return switch (value.data) {
                    ...
                    else => self.priv_list.append(.{ .key = key, .value = value }),
                };
            }

            pub fn moveList(self: *MappingProps) G.Property.List {
                return .moveFromList(&self.priv_list);
            }
        };
