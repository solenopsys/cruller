...
pub fn ArrayListAlignedIn(
    ...
    return struct {
        ...
        priv_unmanaged: Unmanaged = .empty,
        priv_allocator: Allocator,

        pub fn items(self: *const Self) Slice {
            return self.priv_unmanaged.items;
        }

        pub fn capacity(self: *const Self) usize {
            return self.priv_unmanaged.capacity;
        }
        ...
        pub fn initIn(allocator_: Allocator) Self {
            return .{
                .priv_unmanaged = .empty,
                .priv_allocator = allocator_,
            };
        }
        ...
        pub fn initCapacityIn(num: usize, allocator_: Allocator) AllocError!Self {
            return .{
                .priv_unmanaged = try .initCapacity(bun.allocators.asStd(allocator_), num),
                .priv_allocator = allocator_,
            };
        }
        ...
        pub fn deinitShallow(self: *Self) void {
            ...
            self.priv_unmanaged.deinit(self.getStdAllocator());
            bun.memory.deinit(&self.priv_allocator);
        }

        pub fn fromOwnedSlice(allocator_: Allocator, slice: Slice) Self {
            return .{
                .priv_unmanaged = .fromOwnedSlice(slice),
                .priv_allocator = allocator_,
            };
        }
        ...
        pub fn intoUnmanagedWithAllocator(self: *Self) struct { Unmanaged, Allocator } {
            defer self.* = undefined;
            return .{ self.priv_unmanaged, self.priv_allocator };
        }
        ...
        pub fn fromUnmanaged(allocator_: Allocator, unmanaged: Unmanaged) Self {
            return .{
                .priv_unmanaged = unmanaged,
                .priv_allocator = allocator_,
            };
        }

        pub fn toOwnedSlice(self: *Self) AllocError!Slice {
            return self.priv_unmanaged.toOwnedSlice(self.getStdAllocator());
        }
        ...
        pub fn cloneIn(
            ...
            return .{
                .priv_unmanaged = try self.priv_unmanaged.clone(bun.allocators.asStd(allocator_)),
                .priv_allocator = allocator_,
            };
        }

        pub fn insert(self: *Self, i: usize, item: T) AllocError!void {
            return self.priv_unmanaged.insert(self.getStdAllocator(), i, item);
        }

        pub fn insertAssumeCapacity(self: *Self, i: usize, item: T) void {
            self.priv_unmanaged.insertAssumeCapacity(i, item);
        }

        /// Note that this creates *shallow* copies of `value`.
        pub fn addManyAt(self: *Self, index: usize, value: T, count: usize) AllocError![]T {
            const result = try self.priv_unmanaged.addManyAt(self.getStdAllocator(), index, count);
            @memset(result, value);
            return result;
        }
        ...
        pub fn addManyAtAssumeCapacity(self: *Self, index: usize, value: T, count: usize) []T {
            const result = self.priv_unmanaged.addManyAt(index, count);
            @memset(result, value);
            return result;
        }
        ...
        pub fn insertSlice(self: *Self, index: usize, new_items: []const T) AllocError!void {
            return self.priv_unmanaged.insertSlice(self.getStdAllocator(), index, new_items);
        }
        ...
        pub fn replaceRangeShallow(
            ...
            return self.priv_unmanaged.replaceRange(self.getStdAllocator(), start, len, new_items);
        }
        ...
        pub fn replaceRangeAssumeCapacityShallow(
            ...
            self.priv_unmanaged.replaceRangeAssumeCapacity(start, len, new_items);
        }

        pub fn append(self: *Self, item: T) AllocError!void {
            return self.priv_unmanaged.append(self.getStdAllocator(), item);
        }

        pub fn appendAssumeCapacity(self: *Self, item: T) void {
            self.priv_unmanaged.appendAssumeCapacity(item);
        }

        pub fn orderedRemove(self: *Self, i: usize) T {
            return self.priv_unmanaged.orderedRemove(i);
        }

        pub fn swapRemove(self: *Self, i: usize) T {
            return self.priv_unmanaged.swapRemove(i);
        }

        /// This method takes ownership of all elements in `new_items`.
        pub fn appendSlice(self: *Self, new_items: []const T) AllocError!void {
            return self.priv_unmanaged.appendSlice(self.getStdAllocator(), new_items);
        }

        /// This method takes ownership of all elements in `new_items`.
        pub fn appendSliceAssumeCapacity(self: *Self, new_items: []const T) void {
            self.priv_unmanaged.appendSliceAssumeCapacity(new_items);
        }

        /// This method takes ownership of all elements in `new_items`.
        pub fn appendUnalignedSlice(self: *Self, new_items: []align(1) const T) AllocError!void {
            return self.priv_unmanaged.appendUnalignedSlice(self.getStdAllocator(), new_items);
        }

        /// This method takes ownership of all elements in `new_items`.
        pub fn appendUnalignedSliceAssumeCapacity(self: *Self, new_items: []align(1) const T) void {
            self.priv_unmanaged.appendUnalignedSliceAssumeCapacity(new_items);
        }

        /// Note that this creates *shallow* copies of `value`.
        pub inline fn appendNTimes(self: *Self, value: T, n: usize) AllocError!void {
            return self.priv_unmanaged.appendNTimes(self.getStdAllocator(), value, n);
        }

        /// Note that this creates *shallow* copies of `value`.
        pub inline fn appendNTimesAssumeCapacity(self: *Self, value: T, n: usize) void {
            self.priv_unmanaged.appendNTimesAssumeCapacity(value, n);
        }
        ...
        pub fn resizeWithoutDeinit(self: *Self, init_value: T, new_len: usize) AllocError!void {
            const len = self.items().len;
            try self.priv_unmanaged.resize(self.getStdAllocator(), new_len);
            if (new_len > len) {
        ...
        pub fn shrinkAndFreeShallow(self: *Self, new_len: usize) void {
            self.priv_unmanaged.shrinkAndFree(self.getStdAllocator(), new_len);
        }
        ...
        pub fn shrinkRetainingCapacityShallow(self: *Self, new_len: usize) void {
            self.priv_unmanaged.shrinkRetainingCapacity(new_len);
        }
        ...
        pub fn clearRetainingCapacityShallow(self: *Self) void {
            self.priv_unmanaged.clearRetainingCapacity();
        }
        ...
        pub fn clearAndFreeShallow(self: *Self) void {
            self.priv_unmanaged.clearAndFree(self.getStdAllocator());
        }

        pub fn ensureTotalCapacity(self: *Self, new_capacity: usize) AllocError!void {
            return self.priv_unmanaged.ensureTotalCapacity(self.getStdAllocator(), new_capacity);
        }

        pub fn ensureTotalCapacityPrecise(self: *Self, new_capacity: usize) AllocError!void {
            return self.priv_unmanaged.ensureTotalCapacityPrecise(self.getStdAllocator(), new_capacity);
        }

        pub fn ensureUnusedCapacity(self: *Self, additional_count: usize) AllocError!void {
            return self.priv_unmanaged.ensureUnusedCapacity(self.getStdAllocator(), additional_count);
        }

        /// Note that this creates *shallow* copies of `init_value`.
        pub fn expandToCapacity(self: *Self, init_value: T) void {
            const len = self.items().len;
            self.priv_unmanaged.expandToCapacity();
            @memset(self.items()[len..], init_value);
        }

        pub fn pop(self: *Self) ?T {
            return self.priv_unmanaged.pop();
        }
        ...
        fn getStdAllocator(self: *const Self) std.mem.Allocator {
            return bun.allocators.asStd(self.priv_allocator);
        }
    };
}
